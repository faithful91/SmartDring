...
public class DBAdapterSchedules {
	...
	public class DatabaseHelper extends SQLiteOpenHelper {
		...
		public void onCreate(SQLiteDatabase db) {
			db.execSQL("create table " + db_table + " (" + db_id
					...
					+ " text not null, " + db_startHour
					+ " integer not null default 0, " + db_startMinute
					+ " integer not null default 0, " + db_state
					+ " text not null, " + db_day0
					+ " integer not null default 0, " + db_day1
					+ " integer not null default 0, " + db_day2
					+ " integer not null default 0, " + db_day3
					+ " integer not null default 0, " + db_day4
					+ " integer not null default 0, " + db_day5
					+ " integer not null default 0, " + db_day6
					+ " integer not null default 0, " + db_id_ev + " text"
					+ ");");
		}
		...
		public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
			Toast.makeText(
					context,
					"Mise � jour de la Base de donn�es version " + oldVersion
	...
	public long addSchedule(String profileName, int startHour, int startMinute,
			String state, boolean day0, boolean day1, boolean day2,
			boolean day3, boolean day4, boolean day5, boolean day6) {
	...
	public boolean deleteSchedule(String profileId) {
		return db.delete(db_table, "" + db_id + "=" + "'" + profileId + "'",
				null) > 0;
	}
	...
	public int saveNewSchedulePrefInDB(Schedule schedule) {
		int i = 0;
		String selectQuery = "SELECT  * FROM " + db_table;
		Cursor cursor = db.rawQuery(selectQuery, null);
		if (cursor.moveToFirst()) {
	...
	public void addIdEvInDb(int iddb, int iddbev) {
		String selectQuery = "SELECT  * FROM " + db_table + " Where " + db_id
				+ "=" + "'" + iddb + "'";
		Cursor cursor = db.rawQuery(selectQuery, null);
